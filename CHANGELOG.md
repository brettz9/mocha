...
## [12.0.0-rc.1](https://github.com/brettz9/mocha/compare/v12.0.0-rc.5...v12.0.0-rc.1) (2026-08-04)


### ⚠ BREAKING CHANGES

* replace yargs with Node.js util.parseArgs ([#6164](https://github.com/brettz9/mocha/issues/6164))
* replace yargs-unparser in CLI respawn paths ([#6125](https://github.com/brettz9/mocha/issues/6125))
* replace yargs-parser in CLI option loading ([#6124](https://github.com/brettz9/mocha/issues/6124))
* replace he dependency with manual HTML encoding
* change root package.json type to module ([#6078](https://github.com/brettz9/mocha/issues/6078))
* remove `bin/_mocha` and convert `bin/` and entry points to ESM ([#6017](https://github.com/brettz9/mocha/issues/6017))
* remove unused legacy `errors.js` functions ([#5835](https://github.com/brettz9/mocha/issues/5835))
* cleanup references of --compilers ([#5403](https://github.com/brettz9/mocha/issues/5403))
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/brettz9/mocha/issues/5496))
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/brettz9/mocha/issues/5477))
* adapt new engine range for Mocha 11 ([#5216](https://github.com/brettz9/mocha/issues/5216))

### 🌟 Features

* add --clear-screen option for watch mode ([#6133](https://github.com/brettz9/mocha/issues/6133)) ([3301ed7](https://github.com/brettz9/mocha/commit/3301ed7578d2e60cf0e303083d9d6c2d220d13a4))
* add --fail-hook-affected-tests option to report skipped tests as failed ([#5519](https://github.com/brettz9/mocha/issues/5519)) ([0ed524a](https://github.com/brettz9/mocha/commit/0ed524af347b59200e03b972c2450d36f6818a45))
* add built-in github-actions reporter ([#6088](https://github.com/brettz9/mocha/issues/6088)) ([a99b8ba](https://github.com/brettz9/mocha/commit/a99b8ba1d621dc1e1a4e718091f3c7a799e71f39))
...
* add mocha.mjs export ([#5527](https://github.com/brettz9/mocha/issues/5527)) ([e1cf23c](https://github.com/brettz9/mocha/commit/e1cf23cbc2049a375ab9980337dbf2486450f7cb))
...
* add option to use posix exit code upon fatal signal ([#4989](https://github.com/brettz9/mocha/issues/4989)) ([91bbf85](https://github.com/brettz9/mocha/commit/91bbf855012ee9b83700d3c563b517483de0831c))
...
* allow FIFOs as test files ([#5512](https://github.com/brettz9/mocha/issues/5512)) ([ca4af43](https://github.com/brettz9/mocha/commit/ca4af439d5766fdfb2b5a7d7e06db0280b1abb6e))
* bump mimimatch from ^5.1.6 to ^9.0.5 ([#5349](https://github.com/brettz9/mocha/issues/5349)) ([a3dea85](https://github.com/brettz9/mocha/commit/a3dea85b316e229ea95f51c715ad61708e9ab9a3))
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/brettz9/mocha/issues/5477)) ([1c34eef](https://github.com/brettz9/mocha/commit/1c34eef426f29e5e46ec348272ccaa869ae43922))
* bump serialize-javascript from 6.0.2 to 7.0.2 ([#5589](https://github.com/brettz9/mocha/issues/5589)) ([24fb1b6](https://github.com/brettz9/mocha/commit/24fb1b6f8a45b4ca93b4577838bc1d9a47c74ec1))
* bump strip-json-comments from 3 to 5 ([#5484](https://github.com/brettz9/mocha/issues/5484)) ([9b0db24](https://github.com/brettz9/mocha/commit/9b0db24740c65717dcd1838dcafccbfc1c538d3b))
* bump workerpool from ^6.5.1 to ^9.2.0 ([#5350](https://github.com/brettz9/mocha/issues/5350)) ([581a3c5](https://github.com/brettz9/mocha/commit/581a3c554489855ac02860689d3f4ae772c2ea79))
* bump yargs to 17 ([#5165](https://github.com/brettz9/mocha/issues/5165)) ([8f1c8d8](https://github.com/brettz9/mocha/commit/8f1c8d888b0104afcd95ca55a517320399755749))
* bumped glob dependency from 8 to 10 ([#5250](https://github.com/brettz9/mocha/issues/5250)) ([43c3157](https://github.com/brettz9/mocha/commit/43c3157c6ef4f2d4bfecf3ad3a42479fd64187b8))
* change root package.json type to module ([#6078](https://github.com/brettz9/mocha/issues/6078)) ([da015de](https://github.com/brettz9/mocha/commit/da015de4493f6f497802c4fc35ab294e46a59dad))
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/brettz9/mocha/issues/5496)) ([3d94dde](https://github.com/brettz9/mocha/commit/3d94ddea2f45d18473bf00e71db2b9766ab227fe))
* cleanup references of --compilers ([#5403](https://github.com/brettz9/mocha/issues/5403)) ([f75d150](https://github.com/brettz9/mocha/commit/f75d150cf6115334e7f14b8ee1fbbda04eb87087))
* enable reporters to show relative paths of tests ([#5292](https://github.com/brettz9/mocha/issues/5292)) ([81ea666](https://github.com/brettz9/mocha/commit/81ea6667e9286c55ffa67977448b776a23c6da2d))
* ESM configuration file ([#5397](https://github.com/brettz9/mocha/issues/5397)) ([dff9d78](https://github.com/brettz9/mocha/commit/dff9d7873f2d47a799e0adef338a7d6045ba0731))
...
* migrate Markdown lint to `@eslint/markdown` ([#5593](https://github.com/brettz9/mocha/issues/5593)) ([d9e1f0a](https://github.com/brettz9/mocha/commit/d9e1f0aa7e39caa11edb81581c14cd02b3f40b3f))
* remove `bin/_mocha` and convert `bin/` and entry points to ESM ([#6017](https://github.com/brettz9/mocha/issues/6017)) ([930972a](https://github.com/brettz9/mocha/commit/930972a9a705e0b2953d518c0f7ef8ec36c0b9db))
* remove `log-symbols` dependency ([#5469](https://github.com/brettz9/mocha/issues/5469)) ([b92168f](https://github.com/brettz9/mocha/commit/b92168f5625be7343fb94d458d8a055cca8ff0a4))
* remove Sauce Labs ([#5700](https://github.com/brettz9/mocha/issues/5700)) ([625c34e](https://github.com/brettz9/mocha/commit/625c34e8469562dbde8440c2b4d64e820f7019fa))
* replace `strip-ansi` with `util.stripVTControlCharacters` ([#5267](https://github.com/brettz9/mocha/issues/5267)) ([3c191c0](https://github.com/brettz9/mocha/commit/3c191c05d9db1e99aec9b600edac2ce10a6b6d71)), closes [#5265](https://github.com/brettz9/mocha/issues/5265)
* replace yargs-parser in CLI option loading ([#6124](https://github.com/brettz9/mocha/issues/6124)) ([e846f8f](https://github.com/brettz9/mocha/commit/e846f8f54754ecbbfca868885e255bbce51e0582))
* replace yargs-unparser in CLI respawn paths ([#6125](https://github.com/brettz9/mocha/issues/6125)) ([1d2bb2e](https://github.com/brettz9/mocha/commit/1d2bb2efea721474b7fcaac4e209a844e5a463a0))
...
* use require to load esm ([#5366](https://github.com/brettz9/mocha/issues/5366)) ([41e24a2](https://github.com/brettz9/mocha/commit/41e24a242944da0cfc9d4d6989dede85f648cb40))


### 🩹 Fixes

* adapt new engine range for Mocha 11 ([#5216](https://github.com/brettz9/mocha/issues/5216)) ([80da25a](https://github.com/brettz9/mocha/commit/80da25a4132ca50d3ad35087cb62c9b0f8fc946a))
...
* add package.json exports to avoid DEP0151 warning ([#6168](https://github.com/brettz9/mocha/issues/6168)) ([3031567](https://github.com/brettz9/mocha/commit/3031567913b544a97402f449722cc110e9890420))
* allow chain call timeout to override nested items timeout ([#5612](https://github.com/brettz9/mocha/issues/5612)) ([5525da6](https://github.com/brettz9/mocha/commit/5525da60cf8d2596e14ff5441ea518d47bd732da))
* allow importing ESM interface and reporters ([#5563](https://github.com/brettz9/mocha/issues/5563)) ([bc9fc84](https://github.com/brettz9/mocha/commit/bc9fc842213d00cf7ac4a4b0de898bf29e38bdad))
* always fallback to import() if require() fails ([#5384](https://github.com/brettz9/mocha/issues/5384)) ([295c168](https://github.com/brettz9/mocha/commit/295c168628c2583245fb67d371b640309ba243ba))
* begin running tests immediately instead of waiting for watcher, reload required files in watch mode ([#5409](https://github.com/brettz9/mocha/issues/5409)) ([7d9ade6](https://github.com/brettz9/mocha/commit/7d9ade6bffbe09959d4e8acaf33dd22b4edb2b39))
...
* bump diff dependency to ^8.0.3 ([#5674](https://github.com/brettz9/mocha/issues/5674)) ([15fb31a](https://github.com/brettz9/mocha/commit/15fb31a8b25a4d03242e5c5f901ff3800889263e))
* bump diff from ^5.2.0 to ^7.0.0 ([#5348](https://github.com/brettz9/mocha/issues/5348)) ([554d6bb](https://github.com/brettz9/mocha/commit/554d6bbec92c3c938af0a533109749b6f3b7bd2c))
* catch exceptions setting Error.stackTraceLimit ([#5254](https://github.com/brettz9/mocha/issues/5254)) ([259f8f8](https://github.com/brettz9/mocha/commit/259f8f8ba5709b5d84fa66e17cd10560a11f45c9))
* change Pending to properly extend Error ([#5679](https://github.com/brettz9/mocha/issues/5679)) ([158effd](https://github.com/brettz9/mocha/commit/158effd7de677c21b3a4ccd79ce0879fe0f97f8b))
...
* correct assertion import syntax in getting-started guide ([#5526](https://github.com/brettz9/mocha/issues/5526)) ([fb0215b](https://github.com/brettz9/mocha/commit/fb0215bd4fba44fde0cc7b8f9b91a4f07020a13b))
...
* **deps:** update chokidar to v4 ([#5256](https://github.com/brettz9/mocha/issues/5256)) ([8af0f1a](https://github.com/brettz9/mocha/commit/8af0f1a9005a948fbefeb19be618a64dd910d39f))
* **deps:** update dependency @astrojs/starlight to ^0.39.0 ([#5952](https://github.com/brettz9/mocha/issues/5952)) ([eed10ac](https://github.com/brettz9/mocha/commit/eed10acdad8f075488beadedb872a43d4f781285))
* **deps:** update dependency chokidar to v5 ([#5734](https://github.com/brettz9/mocha/issues/5734)) ([ff2f17f](https://github.com/brettz9/mocha/commit/ff2f17fb25e5001420d48035f81f5b19a5f0974f))
* **deps:** update dependency diff to v9 ([#5917](https://github.com/brettz9/mocha/issues/5917)) ([fbd831e](https://github.com/brettz9/mocha/commit/fbd831e9c93e2a704bfa5dca587eb3e664569414))
* **deps:** update dependency js-yaml to v5 ([#6117](https://github.com/brettz9/mocha/issues/6117)) ([2fb44ff](https://github.com/brettz9/mocha/commit/2fb44ffd9eaff5ea86a7f9cfdc4e24c7e4e25c61))
* **deps:** update dependency minimatch to v10 ([#5743](https://github.com/brettz9/mocha/issues/5743)) ([3f3e449](https://github.com/brettz9/mocha/commit/3f3e449f889cb2ddcf950e7bf2268091000b9f7c))
* **deps:** update dependency starlight-package-managers to ^0.12.0 ([#5717](https://github.com/brettz9/mocha/issues/5717)) ([aa4ba48](https://github.com/brettz9/mocha/commit/aa4ba483a4a25f5dfc36334439caf2b8935874d2))
* **deps:** update dependency workerpool to v10 ([#5751](https://github.com/brettz9/mocha/issues/5751)) ([96a4768](https://github.com/brettz9/mocha/commit/96a476831b2852e440357a450c3aebaec0bdb20f))
...
* **docs-next:** backer's logo is consistent regardless of size ([#5594](https://github.com/brettz9/mocha/issues/5594)) ([1a53a10](https://github.com/brettz9/mocha/commit/1a53a100a4f3b83a725ccf3c166dcbefebca8602))
* **docs:** restore homepage logo ([#6183](https://github.com/brettz9/mocha/issues/6183)) ([06e81a8](https://github.com/brettz9/mocha/commit/06e81a800356bb5ea42304e978919d833c8558b4))
* **docs:** restore spacing around footer links ([#6185](https://github.com/brettz9/mocha/issues/6185)) ([163d751](https://github.com/brettz9/mocha/commit/163d751ebb0a9587559ed24aae74564c09f10312))
* error handling for unexpected numeric arguments passed to cli ([#5263](https://github.com/brettz9/mocha/issues/5263)) ([210d658](https://github.com/brettz9/mocha/commit/210d658678a2ec3b6f85c59d4b300b4722671099))
* fail with an informative error message on a file with a broken default import ([#5413](https://github.com/brettz9/mocha/issues/5413)) ([b0e6135](https://github.com/brettz9/mocha/commit/b0e61350594f2a044bf34ea153d1fab1e82e80cc))
...
* handle empty null-prototyped objects ([#5506](https://github.com/brettz9/mocha/issues/5506)) ([2a0bce0](https://github.com/brettz9/mocha/commit/2a0bce02f6f696c74fb8fdcd9f72089e82935903))
...
* import() fallback prevention ([#5647](https://github.com/brettz9/mocha/issues/5647)) ([6a78fa3](https://github.com/brettz9/mocha/commit/6a78fa39576ffb42700811661a94c9ac996707f2))
...
* load mjs files correctly ([#5429](https://github.com/brettz9/mocha/issues/5429)) ([a947b9b](https://github.com/brettz9/mocha/commit/a947b9b95501a35efa73c18aa57a74dad555c03a))
* lookupFiles() now returns string[] for direct file paths ([#5941](https://github.com/brettz9/mocha/issues/5941)) ([4718476](https://github.com/brettz9/mocha/commit/4718476be9727d8ce1c22be65d8f5cca5babc78b)), closes [#5940](https://github.com/brettz9/mocha/issues/5940)
...
* prevent diff hang on large/complex objects ([#5898](https://github.com/brettz9/mocha/issues/5898)) ([6695fba](https://github.com/brettz9/mocha/commit/6695fba397a6d1ca2d7cd4de86d9dda2d3fba342))
* print helpful message when internal CLI error happens ([#5344](https://github.com/brettz9/mocha/issues/5344)) ([1e11836](https://github.com/brettz9/mocha/commit/1e118367dbb27f558edb7389985cca97d6d7da4b))
...
* remove `run` and use globalThis `setup` ([#5592](https://github.com/brettz9/mocha/issues/5592)) ([1544c39](https://github.com/brettz9/mocha/commit/1544c39dcd76916cca23a111c88eee8cbb781c24))
* replace he dependency with manual HTML encoding ([9f85d71](https://github.com/brettz9/mocha/commit/9f85d71769250e515c1a48caf5f31352e16e2c82))
* require serializer.mjs in parallel worker pool files ([#6055](https://github.com/brettz9/mocha/issues/6055)) ([ffdf37c](https://github.com/brettz9/mocha/commit/ffdf37c513481856ee953a9c1ae6418cf435634a))
* strip ANSI sequences from xunit output ([bf76999](https://github.com/brettz9/mocha/commit/bf76999b2b2a99a4442aba34a4ceaa3679898806))
...
* support file: URLs in loadFilesAsync ([#5833](https://github.com/brettz9/mocha/issues/5833)) ([f9f9436](https://github.com/brettz9/mocha/commit/f9f9436aadc68ab496a30e5d9b7ffb72dfe4c32b)), closes [#4993](https://github.com/brettz9/mocha/issues/4993)
* support modern RegExp flags in Mocha#grep ([#5825](https://github.com/brettz9/mocha/issues/5825)) ([35413b6](https://github.com/brettz9/mocha/commit/35413b661023ff3e5e27b120843ee2ebf5902aa4))
* surface global setup/teardown errors with a non-zero exit code ([#5994](https://github.com/brettz9/mocha/issues/5994)) ([ad81ec6](https://github.com/brettz9/mocha/commit/ad81ec68b5182b155937a123e14490e15ae217fe))
* surface ts-node compile errors ([#5572](https://github.com/brettz9/mocha/issues/5572)) ([add4cf8](https://github.com/brettz9/mocha/commit/add4cf8166b330c9af4342def643c606459331d7))
* switch from ansi-colors to picocolors ([#5323](https://github.com/brettz9/mocha/issues/5323)) ([7c08d09](https://github.com/brettz9/mocha/commit/7c08d0944d2255084bc4415238430b13c90f0df5))
...
* use original require() error for TS files if ERR_UNKNOWN_FILE_EXTENSION ([#5408](https://github.com/brettz9/mocha/issues/5408)) ([ebdbc48](https://github.com/brettz9/mocha/commit/ebdbc487693254498de62068c59e3e43d078eff1))
* use semver dot separator for beta pre-release versions (beta-X → beta.X) ([#5764](https://github.com/brettz9/mocha/issues/5764)) ([5574738](https://github.com/brettz9/mocha/commit/557473828570f8883c55cb0e450f153f3f9f8f74))
* watch mode using chokidar v4 ([#5379](https://github.com/brettz9/mocha/issues/5379)) ([c2667c3](https://github.com/brettz9/mocha/commit/c2667c3b3fca33c21306f59a1cca55bb7e1dac1f))
...
* add "failing workaround" and new dash to sec-vuln-reports.mdx ([#5783](https://github.com/brettz9/mocha/issues/5783)) ([f9e553e](https://github.com/brettz9/mocha/commit/f9e553e1acd8d2b09be35ebfc13d2803e0a1ff14))
...
* add banner from old site to new site, link from new to old ([#5414](https://github.com/brettz9/mocha/issues/5414)) ([dedef11](https://github.com/brettz9/mocha/commit/dedef110a2af2f8632fb6c1b864fa0a46ad6ca9c))
* add blog ([#6095](https://github.com/brettz9/mocha/issues/6095)) ([c0280ba](https://github.com/brettz9/mocha/commit/c0280baad8e07d3d7e6f4bce524bf47c102836c1))
* add ClientRedirects.astro ([#5324](https://github.com/brettz9/mocha/issues/5324)) ([b88d441](https://github.com/brettz9/mocha/commit/b88d441cc7616253892572778150998627d746ec))
* add example/tests.html to docs-next ([#5325](https://github.com/brettz9/mocha/issues/5325)) ([6ec5762](https://github.com/brettz9/mocha/commit/6ec5762edd419578e9d3ce2fcc2b8dedcb0caf06))
* add FAQ explainer for dependency security vulnerability reports ([#5691](https://github.com/brettz9/mocha/issues/5691)) ([2517693](https://github.com/brettz9/mocha/commit/2517693683fdd47471a0b6e442adde7487af8b89))
* add FAQ section to CONTRIBUTING.md for "can I work on this?" ([#5689](https://github.com/brettz9/mocha/issues/5689)) ([682c307](https://github.com/brettz9/mocha/commit/682c3076cb3c15530b05bbac265fece99e7db985))
* add info on spies to legacy docs ([#5421](https://github.com/brettz9/mocha/issues/5421)) ([21f5544](https://github.com/brettz9/mocha/commit/21f554459c75f5a75b22556b6e2ac70d6ac0e9fc))
* add instructions for API docs ([#5287](https://github.com/brettz9/mocha/issues/5287)) ([b720ec1](https://github.com/brettz9/mocha/commit/b720ec1b3ca630a90f80311da391b2a0cdfead4e))
* add maintainer expectations to MAINTAINERS.md ([#5514](https://github.com/brettz9/mocha/issues/5514)) ([76f95a1](https://github.com/brettz9/mocha/commit/76f95a1113ea0472800ff6b1781f2750836a6db7))
* add major release strategy, fix typos ([#5551](https://github.com/brettz9/mocha/issues/5551)) ([ec0fe0d](https://github.com/brettz9/mocha/commit/ec0fe0d17401495ad01db3b5bc1adad1f5547009))
...
* add new website using Astro Starlight ([#5246](https://github.com/brettz9/mocha/issues/5246)) ([b1f1cb7](https://github.com/brettz9/mocha/commit/b1f1cb78b655191b7a43dc962b513bf1b076890c))
* add security escalation policy ([#5466](https://github.com/brettz9/mocha/issues/5466)) ([4122c7d](https://github.com/brettz9/mocha/commit/4122c7d13d0941be451365397fbf43e1f3103027))
* add sponsored to sponsorship link rels ([#5097](https://github.com/brettz9/mocha/issues/5097)) ([6531df8](https://github.com/brettz9/mocha/commit/6531df8f19a7459903bab87fb965b3be56624c77))
* add TypeScript setup guide ([#5863](https://github.com/brettz9/mocha/issues/5863)) ([af63dcf](https://github.com/brettz9/mocha/commit/af63dcf772b0884695b3c447df78c62d41cb6472))
...
* added CHANGELOG.md note around 11.1 yargs-parser update ([#5362](https://github.com/brettz9/mocha/issues/5362)) ([618415d](https://github.com/brettz9/mocha/commit/618415d9c6fa3ef4e959207c8dd404f4703de7a7))
...
* agent instructions to help review agents ([#5839](https://github.com/brettz9/mocha/issues/5839)) ([badac5b](https://github.com/brettz9/mocha/commit/badac5b1632235d40ec77fe0365690076ae5e1ae))
* **blog:** add community contributions post ([#6172](https://github.com/brettz9/mocha/issues/6172)) ([5fcc0fe](https://github.com/brettz9/mocha/commit/5fcc0fe4e2bf7a260cd1cc7f312132e26abd1a05))
* **blog:** update community-contributions to 2026-community-sponsorships ([5462d84](https://github.com/brettz9/mocha/commit/5462d841264d28f0bd3c1fe90479b40af6ba03d3))
* bumped docs-next Astro to ^5.16.6 ([#5574](https://github.com/brettz9/mocha/issues/5574)) ([806222b](https://github.com/brettz9/mocha/commit/806222b0998ffb4d09399090f4ec638e90974427))
* clarify --delay option behavior ([#5862](https://github.com/brettz9/mocha/issues/5862)) ([0b88137](https://github.com/brettz9/mocha/commit/0b88137c7d72c11e0dcc0b7b73661061ad8bac8c))
* clarify supported mocha version for ESM configuration ([#6027](https://github.com/brettz9/mocha/issues/6027)) ([5921837](https://github.com/brettz9/mocha/commit/5921837be8d53ea2f6d41e0ca0419aafd428f69e))
* clarify that parallel mode does not provide test isolation ([#5864](https://github.com/brettz9/mocha/issues/5864)) ([274c3d2](https://github.com/brettz9/mocha/commit/274c3d268bd4703d8b1416038eae27e068a0b5b4))
* cleanup third party UI code examples for issue 5570 ([#5784](https://github.com/brettz9/mocha/issues/5784)) ([8d86811](https://github.com/brettz9/mocha/commit/8d86811ecbba26750d2afb3cfab46c99b4bb9440))
* correct outdated `status: accepting prs` link ([#5268](https://github.com/brettz9/mocha/issues/5268)) ([f729cd0](https://github.com/brettz9/mocha/commit/f729cd09b61bb598409f19b3c76b9e9536812237))
* Deploy new site alongside old one ([#5360](https://github.com/brettz9/mocha/issues/5360)) ([6c96545](https://github.com/brettz9/mocha/commit/6c96545aee03efeee78c55feedcf70664426514c))
* document AI-generated code policies ([#5693](https://github.com/brettz9/mocha/issues/5693)) ([3533316](https://github.com/brettz9/mocha/commit/353331663ff65239eb0c3b722978e8f88c773ba5))
* document many "external" services ([#5685](https://github.com/brettz9/mocha/issues/5685)) ([30f8fe6](https://github.com/brettz9/mocha/commit/30f8fe6599cd9e35f7853d7110333d979ff5810c))
* document parent directory lookup for config files ([#5861](https://github.com/brettz9/mocha/issues/5861)) ([e7a98ef](https://github.com/brettz9/mocha/commit/e7a98ef8c232448e44e4e239294e7117df1cee4d))
* downgrade example/tests chai to 4.5.0 ([#5245](https://github.com/brettz9/mocha/issues/5245)) ([eac87e1](https://github.com/brettz9/mocha/commit/eac87e10f49207a9b388f87d77d198583c6f889a))
* explain node import swallowing error ([#5401](https://github.com/brettz9/mocha/issues/5401)) ([09f5b2c](https://github.com/brettz9/mocha/commit/09f5b2c9de67ef40d5bd1775c3fca3bdb138f371))
* fix blog/2026-community-sponsorships description ([#6177](https://github.com/brettz9/mocha/issues/6177)) ([98c4746](https://github.com/brettz9/mocha/commit/98c47466fc7bdfb7e1ff7bdabad04739e892ff09))
...
* fix client redirects ([#5697](https://github.com/brettz9/mocha/issues/5697)) ([dd9145d](https://github.com/brettz9/mocha/commit/dd9145dd9c5a684aa918ca5ed10155293df2bb91)), closes [#5696](https://github.com/brettz9/mocha/issues/5696)
* fix correctness issues in error codes, CLI defaults, and config docs ([#5860](https://github.com/brettz9/mocha/issues/5860)) ([bd54205](https://github.com/brettz9/mocha/commit/bd54205584abe47f4b1588e0ceb7db4dc2cc924b))
...
* fix duplicate global leak documentation ([#5461](https://github.com/brettz9/mocha/issues/5461)) ([1164b9d](https://github.com/brettz9/mocha/commit/1164b9da895e56cf745acda2792e634080018ff6))
* fix examples for `linkPartialObjects` methods ([#5255](https://github.com/brettz9/mocha/issues/5255)) ([34e0e52](https://github.com/brettz9/mocha/commit/34e0e52e047a9119aeae9cb5b660a8438656a1e0))
* fix inconsistencies in docs ([#6000](https://github.com/brettz9/mocha/issues/6000)) ([6310d0e](https://github.com/brettz9/mocha/commit/6310d0ef5e20272d6cc885c5e10534cbed0db662))
* fix light mode Astro accent text color ([#5585](https://github.com/brettz9/mocha/issues/5585)) ([9cc3ada](https://github.com/brettz9/mocha/commit/9cc3ada85b4ab4a4f2a8c7dc1b9d9ff8f101ffc1))
* fix links in new site ([#5416](https://github.com/brettz9/mocha/issues/5416)) ([b2bc769](https://github.com/brettz9/mocha/commit/b2bc769c6c8d87311ba0bdc9df8b9b588494eba5))
* fix month numbers in CHANGELOG.md ([528836e](https://github.com/brettz9/mocha/commit/528836eae9855d30c28bcf9f36577b4f1f34a7c9))
* fix new website typos, improve readability ([#5312](https://github.com/brettz9/mocha/issues/5312)) ([fbceb19](https://github.com/brettz9/mocha/commit/fbceb19bbdad121f0100ec3434258775bd87aeaf))
* fix typo in configuring.mdx ([#5699](https://github.com/brettz9/mocha/issues/5699)) ([fdf1a11](https://github.com/brettz9/mocha/commit/fdf1a11338e5c446ba967dbd2b1324079c8077fc))
* fix v3_older changelog duplicate headings ([#5602](https://github.com/brettz9/mocha/issues/5602)) ([a750518](https://github.com/brettz9/mocha/commit/a7505180b64541ac71639ec3d1193f26e73527d9))
* fix various typos in source and documentation ([#5834](https://github.com/brettz9/mocha/issues/5834)) ([e15bbda](https://github.com/brettz9/mocha/commit/e15bbdacebdc8651d0bfcb2a0c16bfeb367911e5))
...
* improve third-party reporter docs ([#5285](https://github.com/brettz9/mocha/issues/5285)) ([c5a0ef5](https://github.com/brettz9/mocha/commit/c5a0ef523d52d8cab50e4a9b226af3790f54e75f))
* include the released version in the npm badge alt text ([#5959](https://github.com/brettz9/mocha/issues/5959)) ([de924ba](https://github.com/brettz9/mocha/commit/de924bab471e3570415ed2585db4fbd8becd21ff))
...
* mention explicit browser support range ([#5354](https://github.com/brettz9/mocha/issues/5354)) ([c514c0b](https://github.com/brettz9/mocha/commit/c514c0bfad044f8450a63b2f9c6c781b9ce6f164))
* migrate assertion libraries wiki link to main docs ([#5442](https://github.com/brettz9/mocha/issues/5442)) ([95f3ca8](https://github.com/brettz9/mocha/commit/95f3ca8bc3a6c6af2932f7fd59a404768c0c6693))
* migrate count assertions wiki page to docs ([#5438](https://github.com/brettz9/mocha/issues/5438)) ([02a306c](https://github.com/brettz9/mocha/commit/02a306c6cbf31f4eef7d4c9bf5e06c917d3efc11))
* migrate how-to wiki pages to main documentation ([#5463](https://github.com/brettz9/mocha/issues/5463)) ([b85aec6](https://github.com/brettz9/mocha/commit/b85aec6e4307903f31b2b8039dd749efc44ffcf5))
* migrate programmatic usage to docs, development content to DEVELOPMENT.md ([#5464](https://github.com/brettz9/mocha/issues/5464)) ([cb47925](https://github.com/brettz9/mocha/commit/cb47925f99b39bd66bdd09218395bf5e0a54802d))
* migrate remaining legacy wiki pages to main documentation ([#5465](https://github.com/brettz9/mocha/issues/5465)) ([bff9166](https://github.com/brettz9/mocha/commit/bff91660733b71b124aad939538dee7747cfbeb8))
* migrate shared behaviours to docs-next ([#5432](https://github.com/brettz9/mocha/issues/5432)) ([1dc4aa9](https://github.com/brettz9/mocha/commit/1dc4aa98eb3793865fa2a4da3373534dafc1c9a7))
* migrate Spies wiki page to explainers ([#5420](https://github.com/brettz9/mocha/issues/5420)) ([cbcf007](https://github.com/brettz9/mocha/commit/cbcf007c5ae25f203863aac0b43eca1e8aefe093))
* Migrate tagging wiki page to docs ([#5435](https://github.com/brettz9/mocha/issues/5435)) ([876247a](https://github.com/brettz9/mocha/commit/876247a8a636cc7bb1c3bf31390e7771182a090a))
* migrate third party reporters wiki page to docs ([#5433](https://github.com/brettz9/mocha/issues/5433)) ([f70764c](https://github.com/brettz9/mocha/commit/f70764c9a56fcf12e316d5539788c7be0693b6a9))
* migrate third party UIs wiki page to docs ([#5434](https://github.com/brettz9/mocha/issues/5434)) ([6654704](https://github.com/brettz9/mocha/commit/66547045cb9bd2fa8209b34c36da2a5ef49d23fc))
* migrate to global leak wiki page to docs ([#5437](https://github.com/brettz9/mocha/issues/5437)) ([8a6fdca](https://github.com/brettz9/mocha/commit/8a6fdcafccd94c888fae5e8be47dd29a604241b6))
* modernize code examples ([#5687](https://github.com/brettz9/mocha/issues/5687)) ([9c4966a](https://github.com/brettz9/mocha/commit/9c4966a47e7d503fb77704d7559ecab5ce399234))
* modernize DEVELOPMENT.md for new contributors ([#5865](https://github.com/brettz9/mocha/issues/5865)) ([5122ad7](https://github.com/brettz9/mocha/commit/5122ad74d717f29e5c7d59466db774cb6a8b144b))
* modernize spies example, drop should.js ([#6016](https://github.com/brettz9/mocha/issues/6016)) ([3b321a3](https://github.com/brettz9/mocha/commit/3b321a36f13e7317f748547508f376a5f02d1066))
* move legacy site link to bottom of homepage ([#6093](https://github.com/brettz9/mocha/issues/6093)) ([f3e7d37](https://github.com/brettz9/mocha/commit/f3e7d374c717cb1a61297233237c8be53ba5e68e))
...
* replace "New in" with "Since" in version annotations ([#5262](https://github.com/brettz9/mocha/issues/5262)) ([6f10d12](https://github.com/brettz9/mocha/commit/6f10d12c6c6dfa4df7d5221a3ce688f687aaf320))
* switch util.inherits to class extends ([#5677](https://github.com/brettz9/mocha/issues/5677)) ([f6e8d9a](https://github.com/brettz9/mocha/commit/f6e8d9ab58217971e24fd1fb0a4569f50a6ff488))
* sync CLI docs with v12 options and defaults ([#6140](https://github.com/brettz9/mocha/issues/6140)) ([579fd15](https://github.com/brettz9/mocha/commit/579fd1563822564d528d99e10303dd3a5e29116c))
* test/integration/README: remove ref to non-existent dir ([#5516](https://github.com/brettz9/mocha/issues/5516)) ([d2c2d40](https://github.com/brettz9/mocha/commit/d2c2d4026d0f6a09b96344f034e9cba9ee6277af))
* update /next bug report link to be docs issue template ([#5424](https://github.com/brettz9/mocha/issues/5424)) ([668cb66](https://github.com/brettz9/mocha/commit/668cb66e1288051369ab144ccb50c840ebe34267))
* update Contributor License Agreement link in CONTRIBUTING.md ([#5567](https://github.com/brettz9/mocha/issues/5567)) ([410ce0d](https://github.com/brettz9/mocha/commit/410ce0d2a0f799aaca2c0bc627294d70c62dd3f4))
* update maintainer release notes for release-please ([#5453](https://github.com/brettz9/mocha/issues/5453)) ([185ae1e](https://github.com/brettz9/mocha/commit/185ae1eabe5c1e92c758bdfb398f7f47b6ef9483))
* update Node.js version requirements for 11.x ([#5329](https://github.com/brettz9/mocha/issues/5329)) ([abf3dd9](https://github.com/brettz9/mocha/commit/abf3dd921544b45c4c09eef8f7c9c3c4481a3d66))
* update README, LICENSE and fix outdated ([#5197](https://github.com/brettz9/mocha/issues/5197)) ([1203e0e](https://github.com/brettz9/mocha/commit/1203e0ed739bbbf12166078738357fdb29a8c000))
* update sponsor image to be larger ([#5659](https://github.com/brettz9/mocha/issues/5659)) ([bbe2bdb](https://github.com/brettz9/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
* Updates COC Policy To Match OpenJS Guidelines ([#5802](https://github.com/brettz9/mocha/issues/5802)) ([9029f66](https://github.com/brettz9/mocha/commit/9029f668e62a953b8ce52a4b9a479d457faab718))


### 🧹 Chores

* "force" Netlify to use npm to build new site ([#5319](https://github.com/brettz9/mocha/issues/5319)) ([3a46855](https://github.com/brettz9/mocha/commit/3a46855294f82e58a5a414aed3525e394b82aced))
...
* add "descriptions" item to "AI-generated code" ([#6041](https://github.com/brettz9/mocha/issues/6041)) ([efe6167](https://github.com/brettz9/mocha/commit/efe6167abef9f79001af163924bd8fb3582c4145))
* add "Protect Release Please Manifest" workflow ([#6099](https://github.com/brettz9/mocha/issues/6099)) ([2d7bc22](https://github.com/brettz9/mocha/commit/2d7bc22dda9d14beeae1bf89ae7ea5bdbfa8f56a))
* add esm loader test ([#5383](https://github.com/brettz9/mocha/issues/5383)) ([f58e49f](https://github.com/brettz9/mocha/commit/f58e49f08df2066e27f87f93ad7ee9cd6f91d225))
* add issue form for ⚡️ Performance ([#5406](https://github.com/brettz9/mocha/issues/5406)) ([a908b3b](https://github.com/brettz9/mocha/commit/a908b3b86604d41d5751cccfaff505d7092c114f))
* add Knip to docs-next, remove unused deps, and cleanup links ([#5726](https://github.com/brettz9/mocha/issues/5726)) ([a3908e9](https://github.com/brettz9/mocha/commit/a3908e9008c946f3bcc321c2ef630b587727fce4))
...
* add link from bug template to security explainer ([#5782](https://github.com/brettz9/mocha/issues/5782)) ([ab8fc25](https://github.com/brettz9/mocha/commit/ab8fc2504975c34792027cc681f1a96cd79a5b33))
...
* add test for `-R import-only-loader` ([#5391](https://github.com/brettz9/mocha/issues/5391)) ([6ee5b48](https://github.com/brettz9/mocha/commit/6ee5b483b8c29e0593c7765ad7a5c7b7f7764fc3))
* add transient error note to Release Please workflow ([#5847](https://github.com/brettz9/mocha/issues/5847)) ([7288278](https://github.com/brettz9/mocha/commit/7288278faec3f8d021cd6dcc4f4d0d7b4ccc2e75))
* add v12 RC 1 release notes ([#5848](https://github.com/brettz9/mocha/issues/5848)) ([275ce51](https://github.com/brettz9/mocha/commit/275ce519122c154cdd75434de9fde2800416dad1))
* add workflow to handle stale items ([#5831](https://github.com/brettz9/mocha/issues/5831)) ([dd08f6f](https://github.com/brettz9/mocha/commit/dd08f6fab89e29f6f1c157fcf406fe6ceff40fb0))
* add workflow_dispatch to all workflows ([#5793](https://github.com/brettz9/mocha/issues/5793)) ([cca0a2c](https://github.com/brettz9/mocha/commit/cca0a2c9efa20719a2be233a5bd0d9256cc69964))
...
* also test Node.js 24 in CI ([#5405](https://github.com/brettz9/mocha/issues/5405)) ([15f5980](https://github.com/brettz9/mocha/commit/15f59805287f4c84ab8d057735a391a795be23f1))
* applied formatting to all files ([#5493](https://github.com/brettz9/mocha/issues/5493)) ([76d7194](https://github.com/brettz9/mocha/commit/76d719495d09dc4afb37d1179ede8911c52a011e))
* bump CI to use 20.19.4, 22.18.0, 24.6.0 ([#5430](https://github.com/brettz9/mocha/issues/5430)) ([ace5eb4](https://github.com/brettz9/mocha/commit/ace5eb47a7926fe9d56ebcd95fd659c557a5be4d))
...
* bump glob to version 13 ([#5546](https://github.com/brettz9/mocha/issues/5546)) ([f4d4ad2](https://github.com/brettz9/mocha/commit/f4d4ad23e9e994668c7d95c5a9bf59f581dccebf))
* bump Knip to 5.61.2 ([#5394](https://github.com/brettz9/mocha/issues/5394)) ([f3d7430](https://github.com/brettz9/mocha/commit/f3d743061d6523f7077b21749089e6fb2f9c32e3))
* **ci:** use OIDC token for trusted publishing to `npm` ([#5610](https://github.com/brettz9/mocha/issues/5610)) ([dc0fdb7](https://github.com/brettz9/mocha/commit/dc0fdb767fe46b885f7a0ccfb67acfb453156a3b))
...
* cleanup references of --opts ([#5402](https://github.com/brettz9/mocha/issues/5402)) ([1096b37](https://github.com/brettz9/mocha/commit/1096b376c3c3bb9d4256c643ad35a459ed750928))
* configure Release Please for RC ([#6083](https://github.com/brettz9/mocha/issues/6083)) ([8f3a61c](https://github.com/brettz9/mocha/commit/8f3a61c7137632062105e0fdaa6abdd82fe1627d))
* Configure Renovate ([#5678](https://github.com/brettz9/mocha/issues/5678)) ([a9c9b90](https://github.com/brettz9/mocha/commit/a9c9b90098a831d82e69d82bfc7ce8c7aa749911))
* convert `lib/cli/cli.mjs` to ESM ([#5909](https://github.com/brettz9/mocha/issues/5909)) ([6e91a89](https://github.com/brettz9/mocha/commit/6e91a8915e55924a6186e6ac1f5994a81191956c))
* convert `lib/nodejs/` utility files to ESM ([#6011](https://github.com/brettz9/mocha/issues/6011)) ([a8ffaa9](https://github.com/brettz9/mocha/commit/a8ffaa9375e5b8bce9fe8d692474660540586a91))
* convert `lib/reporters/base` to ESM ([#6012](https://github.com/brettz9/mocha/issues/6012)) ([d12dd90](https://github.com/brettz9/mocha/commit/d12dd906aeb7d092a6834586b0c5a4c7d32a0fe3))
* convert commands, init, and lookup-files to ESM ([#5891](https://github.com/brettz9/mocha/issues/5891)) ([46d09d1](https://github.com/brettz9/mocha/commit/46d09d1a8e259300e09b3bc546894878290acac8))
* convert context, hook, and stats-collector to ESM ([#5853](https://github.com/brettz9/mocha/issues/5853)) ([5ac4070](https://github.com/brettz9/mocha/commit/5ac40707fd219c5623eac5802853022d0e8c1a05))
* convert dot, min, and list reporters to esm ([#5907](https://github.com/brettz9/mocha/issues/5907)) ([b19b696](https://github.com/brettz9/mocha/commit/b19b69691b3b0725acacad1e1e3268a6d4762cca))
* convert highlight-tags and parse-query to ESM ([#5855](https://github.com/brettz9/mocha/issues/5855)) ([aad7997](https://github.com/brettz9/mocha/commit/aad799751af28d0979d72e21c1d2a9c183cab46c))
* convert node-flags and options to ESM, fix ESLint issue ([#5900](https://github.com/brettz9/mocha/issues/5900)) ([cd2e461](https://github.com/brettz9/mocha/commit/cd2e46160196fae35b86c3880f70c6d598b94d7f))
* convert run-option-metadata and exports interface to ESM ([#5910](https://github.com/brettz9/mocha/issues/5910)) ([27b0814](https://github.com/brettz9/mocha/commit/27b081488b05e9c673b7fc9acd51ffb4fca77904))
* create exclusions for nyc ([#5609](https://github.com/brettz9/mocha/issues/5609)) ([702473a](https://github.com/brettz9/mocha/commit/702473a54d9348948a63b4600171afa6956ccb0b))
* **deps:** bump unexpected to 13 and remove unused plugins ([#6135](https://github.com/brettz9/mocha/issues/6135)) ([b587012](https://github.com/brettz9/mocha/commit/b587012724d490d4d3ce79890efaf6ec235ae21b))
* **deps:** update actions/checkout action to v7 ([#6114](https://github.com/brettz9/mocha/issues/6114)) ([857945d](https://github.com/brettz9/mocha/commit/857945dbf650ea6bdcdfb2c74cd97a0a391df6ad))
* **deps:** update actions/github-script action to v9 ([#6091](https://github.com/brettz9/mocha/issues/6091)) ([a017f08](https://github.com/brettz9/mocha/commit/a017f08f4d784489949e2b9744716a4f1e705b6d))
* **deps:** update actions/stale action to v10 ([#5842](https://github.com/brettz9/mocha/issues/5842)) ([e75b14f](https://github.com/brettz9/mocha/commit/e75b14fa87616ccafe329e4c21a32980dbf30990))
* **deps:** update dependency @eslint/markdown to v8 ([#5845](https://github.com/brettz9/mocha/issues/5845)) ([bd05089](https://github.com/brettz9/mocha/commit/bd05089ea6d5c68952b3e881be846d9321277ca9))
* **deps:** update dependency @rollup/plugin-alias to v6 ([#5718](https://github.com/brettz9/mocha/issues/5718)) ([267d751](https://github.com/brettz9/mocha/commit/267d751dd05270de4e18e0348584fbb12d90ce04))
* **deps:** update dependency @rollup/plugin-commonjs to v29 ([#5719](https://github.com/brettz9/mocha/issues/5719)) ([9ed4ee5](https://github.com/brettz9/mocha/commit/9ed4ee55d975281ea54f237d23666d7b0307a596))
* **deps:** update dependency @types/node to v24 ([#5958](https://github.com/brettz9/mocha/issues/5958)) ([ef113d7](https://github.com/brettz9/mocha/commit/ef113d7262e8f5d6b602c75a84204863870a4fd5))
* **deps:** update dependency @types/node to v24.13.0 ([#6066](https://github.com/brettz9/mocha/issues/6066)) ([fb1998a](https://github.com/brettz9/mocha/commit/fb1998a350dec3f424015b5b5f01ba98309e5b95))
* **deps:** update dependency astro to v5.17.1 ([#5703](https://github.com/brettz9/mocha/issues/5703)) ([ec3d1fa](https://github.com/brettz9/mocha/commit/ec3d1fa02e285a4430942942c11c376e63d395ca))
* **deps:** update dependency astro to v5.18.1 ([#5786](https://github.com/brettz9/mocha/issues/5786)) ([bf99e30](https://github.com/brettz9/mocha/commit/bf99e300510879259e04115d0961287a16bb3fae))
* **deps:** update dependency chai to v4.5.0 ([#5705](https://github.com/brettz9/mocha/issues/5705)) ([870f9f8](https://github.com/brettz9/mocha/commit/870f9f8df7d1f9cace40bfc29a9b5b79a26ccb4e))
* **deps:** update dependency chai to v6 ([#5720](https://github.com/brettz9/mocha/issues/5720)) ([2e07be1](https://github.com/brettz9/mocha/commit/2e07be139e3ab89c0c882e51ed948d032af4edc5))
* **deps:** update dependency cross-env to v10 ([#5721](https://github.com/brettz9/mocha/issues/5721)) ([20b7476](https://github.com/brettz9/mocha/commit/20b7476904592b356a48c3f89817e930c78f15cb))
* **deps:** update dependency eslint to v10.1.0 ([#5827](https://github.com/brettz9/mocha/issues/5827)) ([2c8eeb0](https://github.com/brettz9/mocha/commit/2c8eeb0296aa9ed8e8acd5baba7de8a45126b591))
* **deps:** update dependency eslint to v10.2.0 ([#5884](https://github.com/brettz9/mocha/issues/5884)) ([2829fe3](https://github.com/brettz9/mocha/commit/2829fe3824fc5b1b06215b23599cbab06972888b))
* **deps:** update dependency eslint to v10.3.0 ([#5945](https://github.com/brettz9/mocha/issues/5945)) ([18cf178](https://github.com/brettz9/mocha/commit/18cf17847379f0b80dacdfe7b37c7625209b2bea))
* **deps:** update dependency eslint to v10.4.0 ([#5996](https://github.com/brettz9/mocha/issues/5996)) ([f2dd26b](https://github.com/brettz9/mocha/commit/f2dd26b996bfc6c902847a14246486bbfa233b58))
* **deps:** update dependency eslint to v10.7.0 ([#6134](https://github.com/brettz9/mocha/issues/6134)) ([26d73d3](https://github.com/brettz9/mocha/commit/26d73d36e345b3ef5d04fa2dce7225ec28598d91))
* **deps:** update dependency eslint-plugin-n to v17.24.0 ([#5798](https://github.com/brettz9/mocha/issues/5798)) ([bb66555](https://github.com/brettz9/mocha/commit/bb66555ea7e917041869faef1934b8ed26368ed2))
* **deps:** update dependency eslint-plugin-n to v18 ([#5948](https://github.com/brettz9/mocha/issues/5948)) ([99f0e4a](https://github.com/brettz9/mocha/commit/99f0e4a39e44508384e992f2edec03a1c37200c2))
* **deps:** update dependency eslint-plugin-n to v18.1.0 ([#6072](https://github.com/brettz9/mocha/issues/6072)) ([6f56135](https://github.com/brettz9/mocha/commit/6f56135a3d64cd450782f442417a731f40e1a97c))
* **deps:** update dependency eslint-plugin-n to v18.2.2 ([#6137](https://github.com/brettz9/mocha/issues/6137)) ([9d925f0](https://github.com/brettz9/mocha/commit/9d925f0969ded263bb7e98cc8ff25bf400694dd8))
* **deps:** update dependency globals to v17 ([#5722](https://github.com/brettz9/mocha/issues/5722)) ([acf9357](https://github.com/brettz9/mocha/commit/acf93578cc6ca9e424f37410bd3b72d38f233aa7))
* **deps:** update dependency globals to v17.5.0 ([#5914](https://github.com/brettz9/mocha/issues/5914)) ([96eaa7c](https://github.com/brettz9/mocha/commit/96eaa7c32a3dfb538f63f9fe717e13da739229da))
* **deps:** update dependency globals to v17.6.0 ([#5946](https://github.com/brettz9/mocha/issues/5946)) ([412070c](https://github.com/brettz9/mocha/commit/412070c7f6570e3bc18cb9769a8b4c85246805db))
* **deps:** update dependency globals to v17.7.0 ([#6126](https://github.com/brettz9/mocha/issues/6126)) ([864fb80](https://github.com/brettz9/mocha/commit/864fb806078f068797317dfab2f513b16ccb66d9))
* **deps:** update dependency installed-check to v10 ([#5738](https://github.com/brettz9/mocha/issues/5738)) ([5905ed9](https://github.com/brettz9/mocha/commit/5905ed9c2c411dfa0e7189ce0d446b2e213422e3))
* **deps:** update dependency js-yaml to v4.2.0 ([#6047](https://github.com/brettz9/mocha/issues/6047)) ([8df3ba6](https://github.com/brettz9/mocha/commit/8df3ba64950fe264fb9ed446b91f58af3e55bd32))
* **deps:** update dependency js-yaml to v4.3.0 ([#6141](https://github.com/brettz9/mocha/issues/6141)) ([bd4fcf4](https://github.com/brettz9/mocha/commit/bd4fcf484bb52e33e9cf57077e6900122f66a25b))
* **deps:** update dependency knip to v5.83.1 ([#5708](https://github.com/brettz9/mocha/issues/5708)) ([d833413](https://github.com/brettz9/mocha/commit/d833413622807c91cc2dea243c2be3518e2fe10b))
* **deps:** update dependency knip to v5.88.0 ([#5799](https://github.com/brettz9/mocha/issues/5799)) ([40ec9b8](https://github.com/brettz9/mocha/commit/40ec9b81403140c198d966f61d954ca5901e5382))
* **deps:** update dependency knip to v6 ([#5828](https://github.com/brettz9/mocha/issues/5828)) ([661f349](https://github.com/brettz9/mocha/commit/661f349ac29e4dbc32c9532ce25fdfd8ba996f01))
* **deps:** update dependency knip to v6.12.1 ([#5942](https://github.com/brettz9/mocha/issues/5942)) ([e29003d](https://github.com/brettz9/mocha/commit/e29003d049979204689a6a7aee2fa0b6bf73dd30))
* **deps:** update dependency knip to v6.14.2 ([#5982](https://github.com/brettz9/mocha/issues/5982)) ([b40e85b](https://github.com/brettz9/mocha/commit/b40e85be119b666981997369f582b3e2e1406e4d))
* **deps:** update dependency knip to v6.15.0 ([#6043](https://github.com/brettz9/mocha/issues/6043)) ([0c03d7d](https://github.com/brettz9/mocha/commit/0c03d7d0681dc5fcc5e1128dd6c0b74a7bbf221a))
* **deps:** update dependency knip to v6.16.1 ([#6067](https://github.com/brettz9/mocha/issues/6067)) ([b204395](https://github.com/brettz9/mocha/commit/b20439531ef88cf766eadc1b8d4c1a12cae17240))
* **deps:** update dependency knip to v6.24.0 ([#6110](https://github.com/brettz9/mocha/issues/6110)) ([bab1d4e](https://github.com/brettz9/mocha/commit/bab1d4e9dff4bc2514466fc1afba2de9d376f4e9))
* **deps:** update dependency knip to v6.26.0 ([#6145](https://github.com/brettz9/mocha/issues/6145)) ([c7cfbe9](https://github.com/brettz9/mocha/commit/c7cfbe9ef945b1422316cf58f19afc9c243397d9))
* **deps:** update dependency knip to v6.3.1 ([#5892](https://github.com/brettz9/mocha/issues/5892)) ([a2675f1](https://github.com/brettz9/mocha/commit/a2675f15e0043d06bf0d19cf98e28def2294ed0b))
* **deps:** update dependency knip to v6.4.0 ([#5901](https://github.com/brettz9/mocha/issues/5901)) ([17ce208](https://github.com/brettz9/mocha/commit/17ce2081912a2e3fbff949469da400c14a1d9529))
* **deps:** update dependency knip to v6.5.0 ([#5916](https://github.com/brettz9/mocha/issues/5916)) ([34465f6](https://github.com/brettz9/mocha/commit/34465f65c0ae0fbdd7c157ba99782da0bbfe27df))
* **deps:** update dependency knip to v6.6.1 ([#5927](https://github.com/brettz9/mocha/issues/5927)) ([7c48496](https://github.com/brettz9/mocha/commit/7c4849672dd5192fd3bc33f4427281ae22f68fc3))
* **deps:** update dependency knip to v6.7.0 ([#5933](https://github.com/brettz9/mocha/issues/5933)) ([441c32a](https://github.com/brettz9/mocha/commit/441c32aa076f2b0e1c1ba39d67f267c46c1dee4b))
* **deps:** update dependency npm-run-all2 to v8 ([#5727](https://github.com/brettz9/mocha/issues/5727)) ([e38e0ec](https://github.com/brettz9/mocha/commit/e38e0ec3dd91be11b2b999959e6245ec721168e3))
* **deps:** update dependency npm-run-all2 to v9 ([#6019](https://github.com/brettz9/mocha/issues/6019)) ([70bea83](https://github.com/brettz9/mocha/commit/70bea8379aa5b76c50bbad4e4e9b584a0d0fbffc))
* **deps:** update dependency nyc to v18 ([#5846](https://github.com/brettz9/mocha/issues/5846)) ([1fea247](https://github.com/brettz9/mocha/commit/1fea247b4e7ba0dafa1a338d438b042ac431d997))
* **deps:** update dependency prettier to v3.8.1 ([#5709](https://github.com/brettz9/mocha/issues/5709)) ([2f98cfd](https://github.com/brettz9/mocha/commit/2f98cfd1e3e9fce8a3c1a645f99a6b4b3b69ea6c))
* **deps:** update dependency prettier to v3.9.5 ([#6142](https://github.com/brettz9/mocha/issues/6142)) ([55df0d1](https://github.com/brettz9/mocha/commit/55df0d141a866b142f53410aa3a5816a82646d2f))
* **deps:** update dependency rimraf to v6 ([#5728](https://github.com/brettz9/mocha/issues/5728)) ([ba124e9](https://github.com/brettz9/mocha/commit/ba124e9161e5efd052df77dda50925c5666ccd6d))
* **deps:** update dependency rollup to v4.57.1 ([#5710](https://github.com/brettz9/mocha/issues/5710)) ([178749d](https://github.com/brettz9/mocha/commit/178749da1bee978b5ef109a253337ae88206365c))
* **deps:** update dependency rollup to v4.59.0 ([#5813](https://github.com/brettz9/mocha/issues/5813)) ([1ef2020](https://github.com/brettz9/mocha/commit/1ef2020023163bd38386e466ab311ec2f5fc3b37))
* **deps:** update dependency rollup to v4.60.0 ([#5829](https://github.com/brettz9/mocha/issues/5829)) ([4ab5813](https://github.com/brettz9/mocha/commit/4ab581328166d828af939be99e69089996d99697))
* **deps:** update dependency rollup to v4.61.0 ([#6050](https://github.com/brettz9/mocha/issues/6050)) ([87696d5](https://github.com/brettz9/mocha/commit/87696d57e4418899e2289c9a2f03143a2ccd92e0))
* **deps:** update dependency rollup to v4.62.0 ([#6103](https://github.com/brettz9/mocha/issues/6103)) ([69e04bf](https://github.com/brettz9/mocha/commit/69e04bf0b9a9becf4875732bbdeca587d8e21b3f))
* **deps:** update dependency semver to v7.8.0 ([#5957](https://github.com/brettz9/mocha/issues/5957)) ([0cbb43c](https://github.com/brettz9/mocha/commit/0cbb43c120c5ce48b6f9df0969c2160bcc6150db))
* **deps:** update dependency sinon to v22 ([#5949](https://github.com/brettz9/mocha/issues/5949)) ([54dcfda](https://github.com/brettz9/mocha/commit/54dcfda422f5260a2a9705c04213db7f37ac7e75))
* **deps:** update dependency sinon to v22.1.0 ([#6188](https://github.com/brettz9/mocha/issues/6188)) ([284f0c2](https://github.com/brettz9/mocha/commit/284f0c23082e3e55106d61c3e69e29f6637b86bd))
* **deps:** update dependency unexpected-map to v3 ([#5736](https://github.com/brettz9/mocha/issues/5736)) ([c1f3379](https://github.com/brettz9/mocha/commit/c1f33798ab925c76c5f9a69dcb8c1ce71da2fbc9))
* **deps:** update dependency unexpected-sinon to v11 ([#5737](https://github.com/brettz9/mocha/issues/5737)) ([e652121](https://github.com/brettz9/mocha/commit/e652121271238f3eca117f465d3d4edad691fdc6))
* **deps:** update dependency unist-util-visit to v5.1.0 ([#5711](https://github.com/brettz9/mocha/issues/5711)) ([7ede894](https://github.com/brettz9/mocha/commit/7ede8943ff8f7925b51d4e4a226ee76b0a77619d))
* **deps:** update dependency webdriverio to v9 ([#5739](https://github.com/brettz9/mocha/issues/5739)) ([ff334df](https://github.com/brettz9/mocha/commit/ff334df744c93f27c7cce08ced320833ee69cb2f))
* **deps:** update dependency webpack to v5.106.1 ([#5893](https://github.com/brettz9/mocha/issues/5893)) ([db85960](https://github.com/brettz9/mocha/commit/db85960a5fda4e9b25da9df5270f19321ec654e5))
* **deps:** update dependency webpack to v5.107.2 ([#6022](https://github.com/brettz9/mocha/issues/6022)) ([5eca67d](https://github.com/brettz9/mocha/commit/5eca67d149cf96474d5a5d18f553222da9d83439))
* **deps:** update dependency webpack to v5.108.4 ([#6150](https://github.com/brettz9/mocha/issues/6150)) ([4e072d1](https://github.com/brettz9/mocha/commit/4e072d14618a2a631077eb9ebce8efabf0b9435a))
* **deps:** update dependency webpack-cli to v6 ([#5741](https://github.com/brettz9/mocha/issues/5741)) ([95c9d75](https://github.com/brettz9/mocha/commit/95c9d75120078e4c1fbb87d23f4fd7ec1f8a5405))
* **deps:** update dependency webpack-cli to v7 ([#5871](https://github.com/brettz9/mocha/issues/5871)) ([9d367e1](https://github.com/brettz9/mocha/commit/9d367e1d31fc03cb744979665a3252aaf47259b4))
* **deps:** update dependency webpack-cli to v7.2.1 ([#6151](https://github.com/brettz9/mocha/issues/6151)) ([19978d7](https://github.com/brettz9/mocha/commit/19978d7b0689b3b6924cdc682c6bb1af2aa49172))
* **deps:** update dependency workerpool to v9.3.4 ([#5715](https://github.com/brettz9/mocha/issues/5715)) ([c030a3b](https://github.com/brettz9/mocha/commit/c030a3bd4774db679ac8dc7d56e705975f1a1b6e))
* **deps:** update eslint monorepo to v10 (major) ([#5742](https://github.com/brettz9/mocha/issues/5742)) ([fe9dc01](https://github.com/brettz9/mocha/commit/fe9dc01850f1c191e758fd60a71d1db8b13cc968))
* **deps:** update eslint monorepo to v10.5.0 ([#6100](https://github.com/brettz9/mocha/issues/6100)) ([ac372e0](https://github.com/brettz9/mocha/commit/ac372e07960f1d41ddba0fe9632c278cfdde0284))
* **deps:** update googleapis/release-please-action action to v5 ([#5929](https://github.com/brettz9/mocha/issues/5929)) ([f32085f](https://github.com/brettz9/mocha/commit/f32085ff2e9794b329b45f06761e710a5baeb4f8))
* **deps:** update joelwmale/webhook-action digest to 6cebc9d ([#5702](https://github.com/brettz9/mocha/issues/5702)) ([e61c8d5](https://github.com/brettz9/mocha/commit/e61c8d5ff69a91f039fd42bed7d7f4988740d0ca))
* **deps:** update playwright monorepo to v1.61.0 ([#6108](https://github.com/brettz9/mocha/issues/6108)) ([7ad398e](https://github.com/brettz9/mocha/commit/7ad398ebf14e4a9255984338619907bf485d6a17))
* **deps:** update remark ([#5745](https://github.com/brettz9/mocha/issues/5745)) ([37a25f1](https://github.com/brettz9/mocha/commit/37a25f174e6f3f16cae34923b86ab7d2504985ce))
* **dev-deps:** upgrade `webpack` from v6 to v7 + remove obsolete `fail-on-errors-webpack-plugin` ([#5908](https://github.com/brettz9/mocha/issues/5908)) ([103ad41](https://github.com/brettz9/mocha/commit/103ad416546bc33804c680cde46de4d0b9ff1c9a))
* **docs:** rename `docs-next` to `docs` ([#5770](https://github.com/brettz9/mocha/issues/5770)) ([39c15a8](https://github.com/brettz9/mocha/commit/39c15a8918e6ec8ebb11d4a2b2b3606b69da4745))
* document CJS and MJS config file priority ([#5923](https://github.com/brettz9/mocha/issues/5923)) ([09a1106](https://github.com/brettz9/mocha/commit/09a11062c701b6776937e3f9b53fd879f71b608c))
* enabled eslint-plugin-n ([#5280](https://github.com/brettz9/mocha/issues/5280)) ([945d6e3](https://github.com/brettz9/mocha/commit/945d6e3bf5a9de19c3aa26fbdac966a721006b58))
* enabled ESLint's no-unused-vars ([#5399](https://github.com/brettz9/mocha/issues/5399)) ([d4168ae](https://github.com/brettz9/mocha/commit/d4168aef4c21f8fd119385da1cf1794a1ec5c2e1))
* explain "trivial changes", update PR template ([#6075](https://github.com/brettz9/mocha/issues/6075)) ([6cbe3d5](https://github.com/brettz9/mocha/commit/6cbe3d5f9fd2e83ef10e97cc2a2cc49aa484a4d4))
* extract stripLeadingDashes helper + cover CLI arg-parsing edge cases ([#6171](https://github.com/brettz9/mocha/issues/6171)) ([867e175](https://github.com/brettz9/mocha/commit/867e17566beb8f7077e969e9c58e9383bcf6d657))
* fix "remove 'waiting for author' " workflow ([#6090](https://github.com/brettz9/mocha/issues/6090)) ([b80d44b](https://github.com/brettz9/mocha/commit/b80d44b3bea01cb4cd7e0bda295ea00a1d6e157d))
* fix broken link in .github/CONTRIBUTING.md ([681e843](https://github.com/brettz9/mocha/commit/681e843800051a9d3ab66c1bfb7ad71428e34315))
...
* fix format workflow permissions for npm-script.yml ([#5903](https://github.com/brettz9/mocha/issues/5903)) ([88a9806](https://github.com/brettz9/mocha/commit/88a9806f39da78110865a591a2cab6253a2a1ad6))
* fix formatting in lib/cli/lookup-files.mjs ([#5912](https://github.com/brettz9/mocha/issues/5912)) ([a3c3a1c](https://github.com/brettz9/mocha/commit/a3c3a1cb295cd177542846004eae735467b31122))
* fix formatting on new remove-waiting-label file ([#6062](https://github.com/brettz9/mocha/issues/6062)) ([bfcb02a](https://github.com/brettz9/mocha/commit/bfcb02a1d12c0f03e8be6771e27aa4135f377bc9))
...
* fix Knip issues ([#5919](https://github.com/brettz9/mocha/issues/5919)) ([1b3d604](https://github.com/brettz9/mocha/commit/1b3d60429e484bde837b86e6eb12b497e2c73c40))
* fix line numbers in stack traces ([#5664](https://github.com/brettz9/mocha/issues/5664)) ([f49aca5](https://github.com/brettz9/mocha/commit/f49aca510c653ad408e8bd433ef190b868f54348))
...
* fix RC 1 blog publish time, rename to `...-rc-1` ([#6106](https://github.com/brettz9/mocha/issues/6106)) ([00d59bc](https://github.com/brettz9/mocha/commit/00d59bc5ff3f8c95235c0b7f500521dc6320440b))
* fix Release Please manifest ([#6097](https://github.com/brettz9/mocha/issues/6097)) ([cfd9cf7](https://github.com/brettz9/mocha/commit/cfd9cf7610f436384ef23d8dcd32f55492fa350c))
...
* fix supporters file extension in knip config ([#5796](https://github.com/brettz9/mocha/issues/5796)) ([53ca72f](https://github.com/brettz9/mocha/commit/53ca72ffcff8162a25a1a6cdb5a636faa0afce17))
* Fix tests ([#5320](https://github.com/brettz9/mocha/issues/5320)) ([18699a0](https://github.com/brettz9/mocha/commit/18699a0d668ed2654dd15433f03b74348baf9559))
* fix timeout issue with some XUnit tests ([53cc467](https://github.com/brettz9/mocha/commit/53cc46755571ed53e32254fb7d896f599a1a7d1f))
* format AGENTS.md ([#5852](https://github.com/brettz9/mocha/issues/5852)) ([16497f2](https://github.com/brettz9/mocha/commit/16497f20f66266d6c8323e4bd2530b2b403f6e8b))
* have `Tests` workflow ignore more relevant paths ([#5762](https://github.com/brettz9/mocha/issues/5762)) ([8e2cebe](https://github.com/brettz9/mocha/commit/8e2cebe14505ce62b0597c854bec217c60c00020))
* inline `escape-string-regexp` (single-regex utility) ([#5883](https://github.com/brettz9/mocha/issues/5883)) ([25e6538](https://github.com/brettz9/mocha/commit/25e65385d849e33f33704785dd6058469bf25cca))
...
* keep stderr out of the JSON parsed by the FIFO test ([#6187](https://github.com/brettz9/mocha/issues/6187)) ([ea6489e](https://github.com/brettz9/mocha/commit/ea6489e973fde53ef2a9e3455110befc064f5ed0))
* limit token perms in protect-manifest workflow ([#6175](https://github.com/brettz9/mocha/issues/6175)) ([8cf0030](https://github.com/brettz9/mocha/commit/8cf003021a4184dfce85367c6622a08b0c8d0891))
...
* **main:** release 11.0.0 prerelease ([#5241](https://github.com/brettz9/mocha/issues/5241)) ([d3b2c38](https://github.com/brettz9/mocha/commit/d3b2c386db74f0d448c7381097381dedb1c996f2))
* **main:** release 11.0.1 ([#5257](https://github.com/brettz9/mocha/issues/5257)) ([4c558fb](https://github.com/brettz9/mocha/commit/4c558fb83ca5d7e260961b1ebfddcd377017a608))
* **main:** release 11.0.2 ([#5269](https://github.com/brettz9/mocha/issues/5269)) ([6caa902](https://github.com/brettz9/mocha/commit/6caa9026eb120b136dc8210614b31310f8bff83b))
* **main:** release 11.1.0 ([#5277](https://github.com/brettz9/mocha/issues/5277)) ([a87fb11](https://github.com/brettz9/mocha/commit/a87fb1130a877649e564e144a73b1716b6296cbd))
* **main:** release 11.2.0 ([#5283](https://github.com/brettz9/mocha/issues/5283)) ([b0c2696](https://github.com/brettz9/mocha/commit/b0c269616e775689f4f28eedc0a9c5e99048139b))
* **main:** release 11.2.1 ([#5316](https://github.com/brettz9/mocha/issues/5316)) ([0d09939](https://github.com/brettz9/mocha/commit/0d09939fa9b710398a14e936dd02d3b5a7a478c2))
* **main:** release 11.2.2 ([#5327](https://github.com/brettz9/mocha/issues/5327)) ([5cf2b09](https://github.com/brettz9/mocha/commit/5cf2b09964fcfcee55eb1ecd2d9a0c56ad7bf526))
* **main:** release 11.3.0 ([#5338](https://github.com/brettz9/mocha/issues/5338)) ([fffe569](https://github.com/brettz9/mocha/commit/fffe5696a6759f99ee305e3ccfe3feb2c96c5acc))
* **main:** release 11.4.0 ([#5368](https://github.com/brettz9/mocha/issues/5368)) ([5730dfc](https://github.com/brettz9/mocha/commit/5730dfcf11e4cd48ba2b24601eaadf34a5c9b1a9))
* **main:** release 11.5.0 ([#5370](https://github.com/brettz9/mocha/issues/5370)) ([a7ed005](https://github.com/brettz9/mocha/commit/a7ed005bf79656c28c6b6e65a197098cdd65d7f4))
* **main:** release 11.6.0 ([#5373](https://github.com/brettz9/mocha/issues/5373)) ([e68b9a6](https://github.com/brettz9/mocha/commit/e68b9a64b3e36c464d0ec565c28e2ffc5b579dd3))
* **main:** release 11.7.0 ([#5378](https://github.com/brettz9/mocha/issues/5378)) ([5d617f3](https://github.com/brettz9/mocha/commit/5d617f3591979dfac68d8a76dfec4b33e9ea78f0))
* **main:** release 11.7.1 ([#5390](https://github.com/brettz9/mocha/issues/5390)) ([c12d85d](https://github.com/brettz9/mocha/commit/c12d85d4ccaae8b2a5a8c0a9de1eaf165657a291))
* **main:** release 11.7.2 ([#5398](https://github.com/brettz9/mocha/issues/5398)) ([5f8e8a8](https://github.com/brettz9/mocha/commit/5f8e8a89fb4cc833290549dcb1974be06514746b))
* **main:** release 11.7.3 ([#5455](https://github.com/brettz9/mocha/issues/5455)) ([c805327](https://github.com/brettz9/mocha/commit/c8053277699b35854eb926ffa7b3b5bebcfbdd44))
* **main:** release 11.7.4 ([#5473](https://github.com/brettz9/mocha/issues/5473)) ([8649f39](https://github.com/brettz9/mocha/commit/8649f394e469b0ec8612837b84707ac42ad2af62))
* **main:** release 12.0.0-beta-1 ([#5549](https://github.com/brettz9/mocha/issues/5549)) ([e648324](https://github.com/brettz9/mocha/commit/e6483245884847ae2e3e468956451ecb9dc31e12))
* **main:** release 12.0.0-beta-10 ([#5701](https://github.com/brettz9/mocha/issues/5701)) ([6cb2710](https://github.com/brettz9/mocha/commit/6cb27100c9a50c17a205803d343a2c369656f0ee))
* **main:** release 12.0.0-beta-2 ([#5552](https://github.com/brettz9/mocha/issues/5552)) ([a7c7eb2](https://github.com/brettz9/mocha/commit/a7c7eb2e2a21ed07a7d4f2ac04dca217eb1d27d3))
* **main:** release 12.0.0-beta-3 ([#5561](https://github.com/brettz9/mocha/issues/5561)) ([8e595c8](https://github.com/brettz9/mocha/commit/8e595c8aefe19e0b87b0ea929eda2a19fe050260))
* **main:** release 12.0.0-beta-4 ([#5598](https://github.com/brettz9/mocha/issues/5598)) ([424516e](https://github.com/brettz9/mocha/commit/424516ed3c34c6716afbf554425cf5df439cd86c))
* **main:** release 12.0.0-beta-4 ([#5620](https://github.com/brettz9/mocha/issues/5620)) ([2fa505c](https://github.com/brettz9/mocha/commit/2fa505ca70293fecaf5b4d8a2d79e108ebb7edfe))
* **main:** release 12.0.0-beta-5 ([#5626](https://github.com/brettz9/mocha/issues/5626)) ([d220832](https://github.com/brettz9/mocha/commit/d220832b8d1360d835d06cb48fd90be4a27d9a0d))
* **main:** release 12.0.0-beta-6 ([#5654](https://github.com/brettz9/mocha/issues/5654)) ([047227f](https://github.com/brettz9/mocha/commit/047227f7eb633c906e287d66b24f0486fe47519c))
* **main:** release 12.0.0-beta-7 ([#5660](https://github.com/brettz9/mocha/issues/5660)) ([611b89d](https://github.com/brettz9/mocha/commit/611b89d5f375748d181ea2a3e912214c6b4f26b1))
* **main:** release 12.0.0-beta-8 ([#5684](https://github.com/brettz9/mocha/issues/5684)) ([bbd0ace](https://github.com/brettz9/mocha/commit/bbd0ace3a489fd562e9881c50532d6e18db7eadc))
* **main:** release 12.0.0-beta-9 ([#5698](https://github.com/brettz9/mocha/issues/5698)) ([430960c](https://github.com/brettz9/mocha/commit/430960c32f239ce830c7cef87a636accfae33150))
* **main:** release 12.0.0-beta-9.2 ([#5768](https://github.com/brettz9/mocha/issues/5768)) ([640f08a](https://github.com/brettz9/mocha/commit/640f08a20d535f7860605b2fe4c54ee1b97cec86))
* **main:** release 12.0.0-beta-9.3 ([#5849](https://github.com/brettz9/mocha/issues/5849)) ([e6e57de](https://github.com/brettz9/mocha/commit/e6e57def32fb97e6a5bbe029a92f5f3b6679d741))
* **main:** release 12.0.0-beta-9.4 ([#5921](https://github.com/brettz9/mocha/issues/5921)) ([724fb50](https://github.com/brettz9/mocha/commit/724fb508acf5b4601c2602df199aba0ef2be921c))
* **main:** release 12.0.0-beta-9.5 ([#5979](https://github.com/brettz9/mocha/issues/5979)) ([a2e2c49](https://github.com/brettz9/mocha/commit/a2e2c497d93bd6d518bc8a61e486993296e2da76))
* **main:** release 12.0.0-beta-9.6 ([#6044](https://github.com/brettz9/mocha/issues/6044)) ([6435342](https://github.com/brettz9/mocha/commit/6435342656e047f23a56cdf7040335452fd76adc))
* **main:** release 12.0.0-rc.1 ([#6061](https://github.com/brettz9/mocha/issues/6061)) ([883e23a](https://github.com/brettz9/mocha/commit/883e23a729984b23f2ec6ce1a369c625f4d29cc7))
* **main:** release 12.0.0-rc.2 ([#6105](https://github.com/brettz9/mocha/issues/6105)) ([f2243a6](https://github.com/brettz9/mocha/commit/f2243a6c4a10405c74884a12916ef83550b8c8a8))
* **main:** release 12.0.0-rc.3 ([#6162](https://github.com/brettz9/mocha/issues/6162)) ([42abcb2](https://github.com/brettz9/mocha/commit/42abcb2750b93a7ea02ed4e4d4d46036e2af8d58))
* **main:** release 12.0.0-rc.4 ([#6169](https://github.com/brettz9/mocha/issues/6169)) ([7450ed4](https://github.com/brettz9/mocha/commit/7450ed4c36e3afd3d1646bbacb8abab43cbba60f))
* **main:** release 12.0.0-rc.5 ([#6170](https://github.com/brettz9/mocha/issues/6170)) ([8458941](https://github.com/brettz9/mocha/commit/84589411b2ac64a59f07acea4d2fc545711484ba))
* migrate 5 unit test files from unexpected to chai ([#5896](https://github.com/brettz9/mocha/issues/5896)) ([fa06dde](https://github.com/brettz9/mocha/commit/fa06dde40cdbcd1bc6e98af19112b1a68a059a29))
* migrate core interfaces and utilities to ESM ([#5930](https://github.com/brettz9/mocha/issues/5930)) ([1ad23ab](https://github.com/brettz9/mocha/commit/1ad23ab544ac7344b0e2840ce91e0817ce71079a))
...
* migrate lib/pending and lib/error-constants to ESM ([#5767](https://github.com/brettz9/mocha/issues/5767)) ([5aacbce](https://github.com/brettz9/mocha/commit/5aacbce08ff25ebe5991cc7ed85a4a8e13b5d3f5))
* migrate reporters to ESM ([#5928](https://github.com/brettz9/mocha/issues/5928)) ([f6a62ca](https://github.com/brettz9/mocha/commit/f6a62cae13bf84dda64d1e12978ace049af89369))
...
* move callback and object typedefs to a new types.d.ts ([#5351](https://github.com/brettz9/mocha/issues/5351)) ([3300d21](https://github.com/brettz9/mocha/commit/3300d2155a1b06059fbe89c98a1d8bf979539019))
* move nyc config changes from package.json into .nycrc ([#5668](https://github.com/brettz9/mocha/issues/5668)) ([e923e40](https://github.com/brettz9/mocha/commit/e923e4063f6a24dcaf7c6d7c7a3c8be998cb7980))
* normalized ESLint config to v9's recommended structure ([#5575](https://github.com/brettz9/mocha/issues/5575)) ([7f9ed1f](https://github.com/brettz9/mocha/commit/7f9ed1fb3480e0658c2c7d84c60a1b505c941ce5))
* pin node-lts tests to 22.11.0 ([#5279](https://github.com/brettz9/mocha/issues/5279)) ([664e1f4](https://github.com/brettz9/mocha/commit/664e1f49f7ae214a9666c90f388407e9fa100309))
* prevent unwanted Prettier rewrites ([#5591](https://github.com/brettz9/mocha/issues/5591)) ([3ea1578](https://github.com/brettz9/mocha/commit/3ea15789ddb4b77c591d9da36d2476ac359de00d))
* raise timeout for node-unit Mocha spec to fix flaky hook ([#6118](https://github.com/brettz9/mocha/issues/6118)) ([31ee8c5](https://github.com/brettz9/mocha/commit/31ee8c5af3ac3a6e7540d7475089d5d054d4a340))
* remove "status: waiting for author" label on review request ([#5983](https://github.com/brettz9/mocha/issues/5983)) ([fa3488d](https://github.com/brettz9/mocha/commit/fa3488d80db56ee328348c4901e25bd9eff8fb4b))
* remove `global.setImmediate` fallback ([#5836](https://github.com/brettz9/mocha/issues/5836)) ([5e69d16](https://github.com/brettz9/mocha/commit/5e69d1659e0f20b8d1b83b6c188ae3e7a3dcf413))
...
* remove `repeat()` polyfill ([#5837](https://github.com/brettz9/mocha/issues/5837)) ([f988a80](https://github.com/brettz9/mocha/commit/f988a8054044593c7854e92f422014de621df63f))
* remove broken browser-test.yml ([#5615](https://github.com/brettz9/mocha/issues/5615)) ([33ce345](https://github.com/brettz9/mocha/commit/33ce345f9ab4f47573a4994c5c01de6eda2af45d))
* remove extra newline ([bbe2bdb](https://github.com/brettz9/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
...
* remove legacy `docs/` ([#5583](https://github.com/brettz9/mocha/issues/5583)) ([d8c310e](https://github.com/brettz9/mocha/commit/d8c310e3eddd235be55ad1891cde84c3be6f56f3))
* remove Node.js 18 from test-smoke in CI too ([d643105](https://github.com/brettz9/mocha/commit/d643105aa6f3fbac9d13e8a44f4c4c7302512193))
* remove now-unused `utils.inherits` ([#5766](https://github.com/brettz9/mocha/issues/5766)) ([d0a636b](https://github.com/brettz9/mocha/commit/d0a636b5e9bd5a4b1c8864b91aec94f12f16490f))
* remove prerelease setting in release-please config ([#5363](https://github.com/brettz9/mocha/issues/5363)) ([8878f22](https://github.com/brettz9/mocha/commit/8878f222c418a0bf4fe170c17573c30b5ea2d567))
* remove trailing spaces ([#5475](https://github.com/brettz9/mocha/issues/5475)) ([7f68e5c](https://github.com/brettz9/mocha/commit/7f68e5c1565606bcebeb715b8591c52973d00dff))
...
* remove unused `libc` props from `package-lock.json` ([#5817](https://github.com/brettz9/mocha/issues/5817)) ([b0a89ce](https://github.com/brettz9/mocha/commit/b0a89ce5eb727cb1f09bb2bf19ec509a792cff54))
* remove unused assets folder ([#5638](https://github.com/brettz9/mocha/issues/5638)) ([ddf8644](https://github.com/brettz9/mocha/commit/ddf864482ff66b1ca46ef7f08e63ca923222e717))
* remove unused fossaignore ([#5769](https://github.com/brettz9/mocha/issues/5769)) ([8a0eaf7](https://github.com/brettz9/mocha/commit/8a0eaf7997ca8f97676412e0e89c1a7df9c0b5c3))
* remove unused legacy `errors.js` functions ([#5835](https://github.com/brettz9/mocha/issues/5835)) ([4116368](https://github.com/brettz9/mocha/commit/41163689264c3ae80c25d168954532b10337aa75))
...
* replace `fs-extra` with newer `fs` built-ins ([#5284](https://github.com/brettz9/mocha/issues/5284)) ([75dcf8c](https://github.com/brettz9/mocha/commit/75dcf8c6c40ed1ce134ae5e174b6f4c4ca4d8c42))
...
* replace Karma with Playwright for browser tests ([#6031](https://github.com/brettz9/mocha/issues/6031)) ([7c9b004](https://github.com/brettz9/mocha/commit/7c9b0046f30076b39f1cb161adad0416ea827606))
* replace yargs with Node.js util.parseArgs ([#6164](https://github.com/brettz9/mocha/issues/6164)) ([21a3902](https://github.com/brettz9/mocha/commit/21a39022861e08a3a8836f365f313f6274dcf485))
* **repo:** change stale threshold from 2+2 to 1+1 ([#6179](https://github.com/brettz9/mocha/issues/6179)) ([7cb2678](https://github.com/brettz9/mocha/commit/7cb267830c51d0b9a851086eb8d87013ee7663bd))
* require exact fixture references in integration tests ([#6096](https://github.com/brettz9/mocha/issues/6096)) ([d602cc7](https://github.com/brettz9/mocha/commit/d602cc7ab9b93169916d267e19071fbeb6cd0468))
* restore cursor in watch failure diagnostics ([#6102](https://github.com/brettz9/mocha/issues/6102)) ([d640269](https://github.com/brettz9/mocha/commit/d640269413414b401980d676d1383b5974010681))
* retry touch in dir-add watch test to reduce flakiness ([#6119](https://github.com/brettz9/mocha/issues/6119)) ([061cb52](https://github.com/brettz9/mocha/commit/061cb529cdec6265d7f8366ad97fd2a054fac21c))
* revert "chore(main): release 12.0.0-beta-4 ([#5598](https://github.com/brettz9/mocha/issues/5598))" ([#5619](https://github.com/brettz9/mocha/issues/5619)) ([dba8091](https://github.com/brettz9/mocha/commit/dba809196541df415fac2681822f5cd35cf20442))
...
* rewrite base path instead of copy-pasting ([#5431](https://github.com/brettz9/mocha/issues/5431)) ([c6c6740](https://github.com/brettz9/mocha/commit/c6c6740fb45da43510f86c1d22ea46ce9ee6a7ae))
* rollback devDep npm-run-all2 to v8 for Node 20 ([#6040](https://github.com/brettz9/mocha/issues/6040)) ([d7d095b](https://github.com/brettz9/mocha/commit/d7d095b6d5e7e0d33e783c4f196c106102d3b82f))
* run tests when PR is retargeted ([#5761](https://github.com/brettz9/mocha/issues/5761)) ([3481b1e](https://github.com/brettz9/mocha/commit/3481b1e32c3ad85e38af9639fc39b53685dd1922))
* switch from Coveralls to Codecov ([#5447](https://github.com/brettz9/mocha/issues/5447)) ([f4e7e54](https://github.com/brettz9/mocha/commit/f4e7e54eb285765d7c50bce9c501db2e1b1e22be))
* switch reporters from util.inherits to ES2015 classes ([#5180](https://github.com/brettz9/mocha/issues/5180)) ([c3f32ce](https://github.com/brettz9/mocha/commit/c3f32ce7e2f39d14beb325892953d3fb1c4922e6))
* switch Runnable, Hook, and Test from util.inherits to ES2015 classes ([#5178](https://github.com/brettz9/mocha/issues/5178)) ([1378fd8](https://github.com/brettz9/mocha/commit/1378fd86071a0c59c0a991569441fe398d0911d8))
* switch Suite from util.inherits to ES2015 classes ([#5179](https://github.com/brettz9/mocha/issues/5179)) ([1ce690e](https://github.com/brettz9/mocha/commit/1ce690e590ca7bff7f47b108d3a5cc61dde6aa1b))
...
* synchronize watch integration tests on observed runs instead of sleeps ([#6058](https://github.com/brettz9/mocha/issues/6058)) ([84af186](https://github.com/brettz9/mocha/commit/84af186b327ac44dd832ae272e31705c4ce19c70))
* tag alpha releases as `alpha`, not `next` ([#5951](https://github.com/brettz9/mocha/issues/5951)) ([8e29413](https://github.com/brettz9/mocha/commit/8e29413678a36a87f41ba4730af3db6507f1b719)), closes [#5947](https://github.com/brettz9/mocha/issues/5947)
* unify caught errors as err ([#5439](https://github.com/brettz9/mocha/issues/5439)) ([d4912e7](https://github.com/brettz9/mocha/commit/d4912e705cf9ae1c3aa274b6449a6a0ff6d408c5))
* unpin node-version in release-please ([#5550](https://github.com/brettz9/mocha/issues/5550)) ([62c90cd](https://github.com/brettz9/mocha/commit/62c90cd2aea4c719d2014e7134b2a1d7c189fd7a))
* Update experimental module detection test and pin exact Node versions ([#5417](https://github.com/brettz9/mocha/issues/5417)) ([2489090](https://github.com/brettz9/mocha/commit/2489090223f2629e4a380abe4cc6d46858ada922))
* update Rollup to v4 ([#5510](https://github.com/brettz9/mocha/issues/5510)) ([cafa782](https://github.com/brettz9/mocha/commit/cafa782f010021e7055f8482ede2c02c6503f0a0))
* update spam filter ([#5645](https://github.com/brettz9/mocha/issues/5645)) ([cf945fb](https://github.com/brettz9/mocha/commit/cf945fb73b7c5a74f0856cabca5b5b1c8a6ff1c8))
* update tagline ([#5635](https://github.com/brettz9/mocha/issues/5635)) ([8ff0209](https://github.com/brettz9/mocha/commit/8ff0209db575c8231eea77e6ab23e6fe95620c92))
* upgrade Astro and its deps ([#6089](https://github.com/brettz9/mocha/issues/6089)) ([66cdd8f](https://github.com/brettz9/mocha/commit/66cdd8f02ce420803d70532215ea9b588e7e78c9))
* upgrade Astro to 7.1.1 ([#6149](https://github.com/brettz9/mocha/issues/6149)) ([a5f1caa](https://github.com/brettz9/mocha/commit/a5f1caa61d6f48d7d970401e22cc8cd205b7ce3a))
* upgrade site to Astro 6 ([#5913](https://github.com/brettz9/mocha/issues/5913)) ([1afd6c7](https://github.com/brettz9/mocha/commit/1afd6c7bd847f67c0a8f8e81000fd45ccec22d91))
* use `beta-9.1` instead of `beta.10` ([#5821](https://github.com/brettz9/mocha/issues/5821)) ([bc1eff2](https://github.com/brettz9/mocha/commit/bc1eff2e44d68c1e06bf3d64a649af96bb00c120))
* use `ps-list` instead of `pidtree` to remove wmic ([#5479](https://github.com/brettz9/mocha/issues/5479)) ([b2985b3](https://github.com/brettz9/mocha/commit/b2985b3428b4b88ca220a14a26e9eb7139e8d445))
* use 1st-party script for blocked-pr.yml ([#6085](https://github.com/brettz9/mocha/issues/6085)) ([54aee06](https://github.com/brettz9/mocha/commit/54aee06a9c49a0bb7827b217ab8ef6986cb071af))
* use OIDC to publish to npm ([#5681](https://github.com/brettz9/mocha/issues/5681)) ([5567aed](https://github.com/brettz9/mocha/commit/5567aed50a00b63074d5c7703c6d8196dee92088))


### 🤖 Automation

* **deps:** bump actions/checkout in the github-actions group ([#5419](https://github.com/brettz9/mocha/issues/5419)) ([03ac2d0](https://github.com/brettz9/mocha/commit/03ac2d0e6e75e95b3dc7fb08f2e1a1117d9718ca))
* **deps:** bump actions/checkout in the github-actions group ([#5547](https://github.com/brettz9/mocha/issues/5547)) ([561eb03](https://github.com/brettz9/mocha/commit/561eb039f7cfc36563a9583b17c7d4cb7ec30652))
* **deps:** bump actions/setup-node from 6 to 7 in the github-actions group across 1 directory ([#6146](https://github.com/brettz9/mocha/issues/6146)) ([a73e34c](https://github.com/brettz9/mocha/commit/a73e34ceda600818ad6d7f5edad5dd9d61014b5f))
* **deps:** bump actions/setup-node in the github-actions group ([#5459](https://github.com/brettz9/mocha/issues/5459)) ([48c6f40](https://github.com/brettz9/mocha/commit/48c6f4068b5d22ebc49220900f0b53f8ecdc2b74))
* **deps:** bump actions/setup-node in the github-actions group ([#5503](https://github.com/brettz9/mocha/issues/5503)) ([9a70533](https://github.com/brettz9/mocha/commit/9a7053349589344236b20301de965030eaabfea9))
* **deps:** bump astro from 6.1.9 to 6.4.4 in /docs ([#6046](https://github.com/brettz9/mocha/issues/6046)) ([f47bcf5](https://github.com/brettz9/mocha/commit/f47bcf5ee91f1a7b747bc82ae9c1642c5e1985ad))
* **deps:** bump codecov/codecov-action from 6 to 7 in the github-actions group ([#6051](https://github.com/brettz9/mocha/issues/6051)) ([00db758](https://github.com/brettz9/mocha/commit/00db758fdbd61762d735ce7d7f76972da43561aa))
* **deps:** bump codecov/codecov-action in the github-actions group ([#5832](https://github.com/brettz9/mocha/issues/5832)) ([525b50a](https://github.com/brettz9/mocha/commit/525b50a2a3f4965b6f663bfba6b9d5dd4f0f5d01))
* **deps:** bump joelwmale/webhook-action in the github-actions group ([#6032](https://github.com/brettz9/mocha/issues/6032)) ([75c618d](https://github.com/brettz9/mocha/commit/75c618d6d85d9754b0d9bb8b2e1709be737de970))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5648](https://github.com/brettz9/mocha/issues/5648)) ([fed6bbd](https://github.com/brettz9/mocha/commit/fed6bbdb891c518e61e8ef4bbf07ed46b469f860))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5653](https://github.com/brettz9/mocha/issues/5653)) ([e06cce7](https://github.com/brettz9/mocha/commit/e06cce7a49b79a163e33db166e9b078b0d7b4001))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5724](https://github.com/brettz9/mocha/issues/5724)) ([87224d8](https://github.com/brettz9/mocha/commit/87224d8400fa3b074f77a8ba1baadf7e0b99d864))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5791](https://github.com/brettz9/mocha/issues/5791)) ([fb6bfd6](https://github.com/brettz9/mocha/commit/fb6bfd6425729a3516c60933298988a5711a6edc))
...
* **dep:** update `diff` from v7 to v8 ([#5605](https://github.com/brettz9/mocha/issues/5605)) ([8ca311c](https://github.com/brettz9/mocha/commit/8ca311c6c9b0d353b1c9d65b5751296d9baddd83))
* **dev-deps:** upgrade `eslint` from v8 to v9 ([#5559](https://github.com/brettz9/mocha/issues/5559)) ([bb24ca8](https://github.com/brettz9/mocha/commit/bb24ca8fde15471ff68d5b01b74c2d7e6047d966))
* **dev-deps:** upgrade `markdownlint-cli` to latest v0.46.0  ([#5560](https://github.com/brettz9/mocha/issues/5560)) ([a124f1d](https://github.com/brettz9/mocha/commit/a124f1d3b7d0f8277962cae295cd43878294e183))
* **dev-deps:** upgrade `nyc` from 15 to 17 ([#5556](https://github.com/brettz9/mocha/issues/5556)) ([599ab01](https://github.com/brettz9/mocha/commit/599ab013f526e78b3888a092a928ea4bc67138c0))
* **docs/dev-deps:** use JS-native `fetch` to get supporters data instead of external `needle` ([#5643](https://github.com/brettz9/mocha/issues/5643)) ([e37e56f](https://github.com/brettz9/mocha/commit/e37e56fbe6a1072f1784ef87278d46f7ac48cdb8))
...
* run `npm audit fix` ([#5695](https://github.com/brettz9/mocha/issues/5695)) ([c7b00b0](https://github.com/brettz9/mocha/commit/c7b00b0e4f03583c4dcc407f28a5453df436f32b))
* update npm command for format ([#5603](https://github.com/brettz9/mocha/issues/5603)) ([c6a29cc](https://github.com/brettz9/mocha/commit/c6a29ccb38f81d65100cb2a0e6d73ad4303f58fb))
